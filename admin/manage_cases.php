    ...
    <div class="container">
        ...
        <div class="card fade-in">
            ...
            <form method="POST" class="case-form">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <select id="case_type" name="case_type" class="form-control" required>
                            ...
                            <option value="قضية مدنية" <?php echo ($current_case && $current_case['case_type'] === 'قضية مدنية') ? 'selected' : ''; ?>>قضية ادارية</option>
                            <option value="قضية جنائية" <?php echo ($current_case && $current_case['case_type'] === 'قضية جنائية') ? 'selected' : ''; ?>>قضية تنفيذية</option>
                            <option value="قضية تجارية" <?php echo ($current_case && $current_case['case_type'] === 'قضية تجارية') ? 'selected' : ''; ?>>قضية تجارية</option>
                            <option value="قضية عمالية" <?php echo ($current_case && $current_case['case_type'] === 'قضية جزائية جسيمة') ? 'selected' : ''; ?>>قضية جزائية جسيمة</option>
                            <option value="قضية عمالية" <?php echo ($current_case && $current_case['case_type'] === 'قضية جزائية غير جسيمة') ? 'selected' : ''; ?>>قضية جزائية غير جسيمة</option>

                            <option value="قضية أسرية" <?php echo ($current_case && $current_case['case_type'] === 'قضية شخصية') ? 'selected' : ''; ?>>قضية شخصية</option>
                            <option value="قضية إدارية" <?php echo ($current_case && $current_case['case_type'] === 'قضية إدارية') ? 'selected' : ''; ?>>قضية مدنية</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="description">موضوع القضية:</label>
